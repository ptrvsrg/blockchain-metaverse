...
/**
 * Класс ConnectionConfig предоставляет методы для доступа и получения свойств, связанных с настройками соединения,
 * из файла конфигурации "connection.properties".
 */
public class ConnectionConfig {
    ...
    /**
     * Возвращает свойство "connection.hash160_1" из файла конфигурации.
     * Если свойства еще не были загружены, вызывает метод readConfigFile() для загрузки.
     *
    ...
    /**
     * Возвращает свойство "connection.hash160_2" из файла конфигурации.
     * Если свойства еще не были загружены, вызывает метод readConfigFile() для загрузки.
     *
     * @return значение свойства "connection.hash160_2" или null, если свойства не были
