...
/**
 Класс ChoiceController отвечает за управление выбором действий на главной странице.
 Здесь пользователь может выбрать вход в систему или регистрацию нового аккаунта.
 */
public class ChoiceController {
    ...
    /**
     ...
     Загружает страницу для входа в систему и отображает её на переданном AnchorPane.
    ...
    /**
     ...
     Загружает страницу для регистрации нового аккаунта и отображает её на переданном AnchorPane.
